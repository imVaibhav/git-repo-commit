...
//
//     final gitRepos = gitReposFromJson(jsonString);

import 'dart:convert';

List<GitRepos> gitReposFromJson(String str) =>
    List<GitRepos>.from(json.decode(str).map((x) => GitRepos.fromJson(x)));

String gitReposToJson(List<GitRepos> data) =>
...
class GitRepos {
  ...
  factory GitRepos.fromJson(Map<String, dynamic> json) => GitRepos(
        ...
        hasDiscussions:
            json["has_discussions"] == null ? null : json["has_discussions"],
        ...
        allowForking:
            json["allow_forking"] == null ? null : json["allow_forking"],
        isTemplate: json["is_template"] == null ? null : json["is_template"],
        webCommitSignoffRequired: json["web_commit_signoff_required"] == null
            ? null
  ...
  Map<String, dynamic> toJson() => {
        ...
        "has_discussions": hasDiscussions == null ? null : hasDiscussions,
        ...
        "allow_forking": allowForking == null ? null : allowForking,
        "is_template": isTemplate == null ? null : isTemplate,
        "web_commit_signoff_required":
            webCommitSignoffRequired == null ? null : webCommitSignoffRequired,
        "topics":
